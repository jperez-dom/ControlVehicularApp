 ...
 */
final class Version20251027183258 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE log_action (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, user_name VARCHAR(50) NOT NULL, action VARCHAR(255) NOT NULL, table_name VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_5236DF30A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE pass (id INT AUTO_INCREMENT NOT NULL, comission_id INT NOT NULL, departure_mileage INT DEFAULT NULL, arrival_mileage INT DEFAULT NULL, fuel VARCHAR(50) NOT NULL, departure_comment LONGTEXT DEFAULT NULL, arrival_comment LONGTEXT DEFAULT NULL, start_date DATETIME NOT NULL, end_date DATETIME NOT NULL, status VARCHAR(1) DEFAULT \'1\' NOT NULL, created_at DATETIME DEFAULT CURRENT_TIMESTAMP, updated_at DATETIME DEFAULT CURRENT_TIMESTAMP, INDEX IDX_CE70D424BAD3DC8F (comission_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
