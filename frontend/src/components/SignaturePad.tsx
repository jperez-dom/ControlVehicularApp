...
export function SignaturePad({ value, onChange, onSignatureChange, disabled = false, id, clearButtonText = 'Borrar' }: SignaturePadProps) {
    // Usar onSignatureChange si existe, sino onChange
    const handleChange = onSignatureChange || onChange || (() => {});
