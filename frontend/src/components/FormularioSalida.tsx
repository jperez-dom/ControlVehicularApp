...
export function FormularioSalida({ ficha, onBack, onComplete }: FormularioSalidaProps) {
    ...
    const handleKmChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        updateFormData('kmSalida', formatted);
    };
    ...
    const handlePhotoPreviewRetry = () => {
        ...
        if (photoPreview.interiorPhotoId) {
            setFormData(prev => ({
                ...prev,
                fotosInteriores: prev.fotosInteriores.map(f =>
                    f.id === photoPreview.interiorPhotoId ? { ...f, foto: '' } : f
                )
            }));
        } else if (photoPreview.photoKey) {
            updateFormData(photoPreview.photoKey, '');
        }

        // Cerrar el modal para que el usuario pueda volver a capturar
        setPhotoPreview({
            open: false,
            photoData: '',
            photoType: '',
            ...
            <div className="space-y-0">
                ...
                <div className="bg-white px-4 py-4 border-b border-gray-200">
                    <div className="flex items-center gap-3">
                        ...
                        <h1 className="text-black text-xl flex-1 text-center mr-11">Salida</h1>
                    </div>
                </div>
            </div>
            ...
            <div className="overflow-y-auto pb-32">
                <div className="max-w-[360px] mx-auto px-4 py-6 space-y-6">
                    ...
                    <div className="bg-white rounded-lg p-4 space-y-4">
                            ...
                            <div>
                                ...
                                <div className="mt-1">
                                    <CalendarPicker
                                        ...
                                        onValueChange={(value) => updateFormData('fechaSalida', value)}
                                        placeholder="Fecha"
                                    />
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div className="mt-1">
                                    <BottomSheetDatePicker
                                        ...
                                        onValueChange={(value) => updateFormData('horaSalida', value)}
                                        placeholder="Hora"
                                    />
                                </div>
                            </div>
                                        ...
                                        {getPhotoStatus('fotoKilometraje') === 'captured' ? (
                                            <button
                                                ...
                                                onClick={() => {
                                                    setPhotoPreview({
                                                        open: true,
                                                        photoData: formData.fotos.fotoKilometraje,
                                                        photoType: 'Odómetro',
                                                        photoKey: 'fotoKilometraje',
                                                        interiorPhotoId: ''
                                                    });
                                                }}
                                    ...
                                    getPhotoStatus(foto.key) === 'captured' ? (
                                        <button
                                            ...
                                            onClick={() => {
                                                setPhotoPreview({
                                                    open: true,
                                                    photoData: formData.fotos[foto.key as keyof typeof formData.fotos],
                                                    photoType: foto.label,
                                                    photoKey: foto.key,
                                                    interiorPhotoId: ''
                                                });
                                            }}
                        ...
                        {/* Comentarios */}
                        <div>
                            <Label htmlFor="departure_comment">
                                Comentarios (opcional)
                            </Label>
                            <div className="mt-2">
                                <Textarea
                                    id="departure_comment"
                                    placeholder="Escribe observaciones o comentarios adicionales..."
                                    value={formData.departure_comment}
                                    onChange={(e) => updateFormData('departure_comment', e.target.value)}
                                    rows={4}
