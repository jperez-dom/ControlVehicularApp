...
export function FormularioEntrada({ ficha, onBack, onComplete }: FormularioEntradaProps) {
    ...
    const [errors, setErrors] = useState({
        ...
        signature_conductor: false,
        signature_approver: false
    });
    ...
    const validateForm = () => {
        const newErrors = {
            ...
            signature_conductor: !formData.signature_conductor,
            signature_approver: !formData.signature_approver
        };
                    ...
                    <div className="bg-white rounded-lg p-4 space-y-4">
                        ...
                        <div>
                            ...
                            <div className="mt-2">
                                <Textarea
                                    ...
                                    value={formData.arrival_comment}
                                    onChange={(e) => updateFormData('arrival_comment', e.target.value)}
                                    rows={4}
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <div className="mt-2">
                                    <SignaturePad
                                        id="signature_conductor"
                                        onSignatureChange={(signature) => updateFormData('signature_conductor', signature)}
                            ...
                            <div>
                                ...
                                <div className="mt-2">
                                    <SignaturePad
                                        id="signature_approver"
                                        onSignatureChange={(signature) => updateFormData('signature_approver', signature)}
                                        clearButtonText="Borrar"
                                    />
                                </div>
                            </div>
